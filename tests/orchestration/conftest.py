...
_GAL = "pokepoke.orchestration.gate_agent_loop"
_FIN = "pokepoke.orchestration.finalization"
PATCH_WF_INVOKE_COPILOT = f"{_WF}.invoke_copilot"
PATCH_WF_RUN_GATE_AGENT = f"{_GAL}.run_gate_agent"
...
PATCH_WF_BLOCK_ITEM = f"{_WF}.block_item"
PATCH_WFH_UNCOMMITTED = f"{_WFH}.has_uncommitted_changes"
PATCH_WFH_FINALIZE = f"{_FIN}.finalize_work_item"
PATCH_WFH_BETA_TESTER = f"{_FIN}.run_beta_tester"

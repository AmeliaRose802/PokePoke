...
class TestSubprocessEncodingConfig:
    ...
    def test_check_copilot_processes_uses_utf8_with_replace(self, mock_run, mock_os):
        ...
        import pokepoke.process_utils as mod
    ...
    def test_run_bd_uses_utf8_with_replace(self, mock_run):
        ...
        from pokepoke.beads_query import _run_bd
        _run_bd(['ready', '--json'])
    ...
    @patch('pokepoke.git_helpers.subprocess.run')
    def test_run_git_status_with_retry_uses_utf8_with_replace(self, mock_run):
        ...
        from pokepoke.git_helpers import _run_git_status_with_retry
...
class TestUnicodeOutputHandling:
    ...
    def test_beads_query_handles_emoji_json(self, mock_run):
        ...
        from pokepoke.beads_query import _parse_beads_json
...
class TestNoneAndEmptyOutputHandling:
    ...
    def test_get_ready_work_items_handles_empty_stdout(self, mock_run):
        ...
        from pokepoke.beads_query import get_ready_work_items
    ...
    def test_backfill_handles_empty_beads_db(self, tmp_path):
        ...
        with patch("pokepoke.beads_item_stats_backfill._get_all_beads_items") as mock_items:
    ...
    def test_get_issue_dependencies_returns_none_on_failure(self, mock_run):
        ...
        from pokepoke.beads_query import get_issue_dependencies
    ...
    @patch('pokepoke.beads_query._get_main_repo_root')
    @patch('pokepoke.beads_query.subprocess.run')
    def test_get_beads_stats_success(self, mock_run, mock_root):
        ...
        from pokepoke.beads_query import get_beads_stats
    ...
    def test_get_main_repo_root_returns_none_on_runtime_error(self):
        ...
        with patch('pokepoke.git_operations.get_main_repo_root', side_effect=RuntimeError("not a repo")):
            from pokepoke.beads_query import _get_main_repo_root

...
class MCPClient {
    ...
    async start() {
        return new Promise((resolve, reject) => {
            ...
            console.log('Waiting for server to build and start (12 seconds)...');
...
async function testCreateIncidentFolder() {
    const client = new MCPClient('c:\\Users\\ameliapayne\\icm_queue_c#\\start-mcp-server.ps1');
    let exitCode = 0;

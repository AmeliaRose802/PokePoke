...
# prompts.py lives in src/pokepoke/prompts/, builtin_prompts is at src/pokepoke/builtin_prompts/
BUILTIN_PROMPTS_DIR = (Path(__file__).parent.parent / "builtin_prompts").resolve(
    strict=False
)

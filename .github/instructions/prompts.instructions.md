...
**NOTE:** This ICM Queue MCP server currently does not use AI-powered prompts or analysis features. This file is included for future extensibility if AI-powered incident analysis is added.

If you need to add AI-powered features to this server in the future, this directory would contain prompt templates for:
...
If prompts are added, they should follow this organization:

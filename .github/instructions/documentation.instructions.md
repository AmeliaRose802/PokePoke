...
This directory contains user-facing documentation for the ICM Queue MCP server.

## Documentation Structure

```
docs/
├── (future feature specs would go here)
└── README.md and EXAMPLE_USAGE.md in project root
```

**Current Status:** This project currently maintains documentation in:
- `README.md` - Main project documentation and setup
- `EXAMPLE_USAGE.md` - Usage examples and tool documentation

As the project grows, feature specifications may be added to a `docs/` directory.

## Documentation Standards

### File Naming Conventions

- Main docs: `README.md`, `EXAMPLE_USAGE.md`
- Future feature specs: `kebab-case.md` (e.g., `incident-context-retrieval.md`)
- Guides: `SCREAMING_SNAKE_CASE.md` (e.g., `KUSTO_BEST_PRACTICES.md`)
...
**Update README.md or EXAMPLE_USAGE.md for:**
- New MCP tools
- New query patterns or templates
- Configuration changes
- Usage examples

**Future: Create feature specs (in docs/) for:**
- Complex new features requiring detailed documentation
- When multiple related tools are added
...
✅ **Good:**
```markdown
The `get_incident_context` tool retrieves comprehensive incident information
from Kusto in a single query. Specify the incident ID, cluster, and database.
```

❌ **Bad:**
```markdown
The get_incident_context tool can be used to get incident information. You
might want to use this tool when you need incident data from Kusto.
It will retrieve the incident if you provide the necessary parameters.
```
